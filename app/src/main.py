...
def router_node(state: GraphState) -> str:
    ...
    The **vectorstore** contains documents about **Python documentation, programming concepts, libraries, frameworks, and development**. The **web_search** tool can access real-time information about latest python information. 
...
def main():
    st.title("🤖 ChatGPT")
    st.markdown("Ask questions about Python documentation, programming concepts, libraries, frameworks, and development topics!")
    ...
    # Chat input
    if question := st.chat_input("Ask a question about Python documentation, programming concepts, libraries, frameworks, and development topics..."):
